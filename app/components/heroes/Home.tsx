      ...
      <div className="flex flex-col lg:flex-row gap-[43px]">
        ...
        <div className="w-full lg:w-[58%] relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <p className="font-Roboto text-PrimaryBlack font-medium leading-[21px] md:leading-[24px] text-[14px] md:text-[16px]">
          ...
          <div className="flex flex-col md:flex-row flex-wrap gap-x-5 gap-y-[18px] md:gap-y-4 pt-[56px] lg:pt-[130px] text-sm text-gray-700">
            ...
            <BannerIcon1 />
              <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]">  Real Street Addresses     
            </span> 
            </div>
            <div className="flex items-center gap-3 md:gap-2 min-w-[195px] relative after:content-[''] after:hidden md:after:block md:after:right-0 md:after:absolute md:after:w-[1px] md:after:h-[20px] md:after:bg-LightWhite">
        
                <BannerIcon2 />
                <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]">Open & Scan Mail</span>               
            </div>
            <div className="flex items-center gap-3 md:gap-2 min-w-[195px]">
              
                   <BannerIcon3 />
                <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]">Mail & Package Forwarding  </span>
            </div>
            <div className="flex items-center gap-3 md:gap-2 min-w-[195px] relative after:content-[''] after:hidden md:after:block md:after:right-0 md:after:absolute md:after:w-[1px] md:after:h-[20px] md:after:bg-LightWhite">
              
                    <BannerIcon4 />
                <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]">Free Online Storage   </span>
            </div>
            <div className="flex items-center gap-3 md:gap-2 min-w-[195px] relative after:content-[''] after:hidden md:after:block md:after:right-0 md:after:absolute md:after:w-[1px] md:after:h-[20px] md:after:bg-LightWhite">
       
                <BannerIcon5 />
                <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]"> Check Deposit   </span>
            </div>
            <div className="flex items-center gap-3 md:gap-2 min-w-[195px]">
             
           <BannerIcon6 />
                <span className="font-Roboto text-PrimaryBlack font-normal leading-[24px] text-[16px]"> Global Network  </span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-[42%] hidden md:flex gap-4 justify-center">
          ...
          <div className="relative">
            ...
            />
               <span className='font-Roboto text-PrimaryBlack font-medium leading-[21px] text-[14px]'> Your Cheque is cleared successfully </span>
            </div>
          </div>
          </div>
          ...
          <div className="">
            ...
            />
               ...
               <span className='font-Roboto text-PrimaryBlack font-medium leading-[21px] text-[14px]'>Your Forwarding request has been submitted </span>
            </div>
            </div>
          </div>
        </div>
