              ...
              <div className="space-y-[3px]">
                {activeData.services?.map((service, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`flex flex-col px-6 relative rounded-[12px] transition-all duration-500 ${
                    ...
                    >
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p className="font-Roboto text-PrimaryBlack font-medium leading-[27px] text-[18px]">
                          {service.title}
                        </p>
                      </div>
                      ...
                      >
                        {service.description && (
                          <p className="pl-10 max-w-[380px] font-Roboto text-PrimaryBlack text-[14px] leading-[21px]">
                            {service.description}
                          </p>
                        )}
