...
const SolutionRealLife: React.FC<{ data: SolutionRealLifeProps }> = ({ data }) => {
  return (
    <section className="overflow-hidden relative bg-PrimaryBlack text-white py-[40px] md:py-[60px] lg:py-[100px] px-5">
      <div className="absolute top-[-20px] right-[-40px] md:right-[0]">
      ...
      <div className="max-w-[1165px] mx-auto flex flex-col md:flex-row gap-[44px] md:gap-[64px] lg:gap-[162px] items-center">
