    ...
    <section className="border-b border-[#DCDCDC] py-14">
      <div className="max-w-[1240px] mx-auto  max-1265px:px-4 max-1265px:gap-2 md:gap-[62px] grid md:grid-cols-2 items-center">
        ...
        <div>
          ...
          <h2 className="max-w-[444px] mt-5 font-Roboto text-PrimaryBlack font-semibold leading-[31.2px] tracking-[-0.36px] text-[24px] md:text-[36px] md:leading-[43.2px] md:tracking-[-0.54px]">{data?.heading}</h2>
