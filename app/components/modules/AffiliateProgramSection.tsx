    ...
    <section className="px-5 py-[40px] md:py-[54px] bg-white">
      ...
      <div className="w-full md:w-[48.1%] space-y-5 md:space-y-5">
        ...
        {ctaText && (
          <a
            href={ctaUrl ?? "#"}
            className="group relative flex items-center justify-center w-full md:w-[249px] h-[44px] md:h-[52px] rounded-full bg-DarkOrange px-4 py-3 text-white  font-Roboto font-normal text-[16px] md:text-[16px] leading-[16px] tracking-[0.08px] overflow-hidden transition-all hover:scale-[1.01] hover:bg-[#DD5827]"
          >
