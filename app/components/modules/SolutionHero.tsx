    ...
    <section className="px-5 py-[40px] md:py-[60px] lg:py-[95px]">
      <div className="max-w-[1240px] mx-auto flex flex-col md:flex-row gap-[45px] md:gap-[65px] items-center">
        ...
        <div className="w-full md:w-[54.25%] flex flex-col relative">
          <div className="hidden md:flex absolute top-[-29px] md:right-[-70px] lg:right-[-30px] xl:right-[-15px]">
          ...
          {data?.cta?.label && (
            <Link to={data?.cta?.url || "#"} className="flex items-center justify-center w-full md:w-[207px] bg-DarkOrange text-white font-Roboto font-medium leading-[16px] text-[16px] tracking-[0.08px] h-[52px] pl-[63px] pr-[59px] py-[14px] rounded-[100px] overflow-hidden transition-all hover:scale-[1.01] hover:bg-[#DD5827]">
              {data.cta.label}             
            </Link>
          )}
