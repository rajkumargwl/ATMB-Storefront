...
import AuthorImage from "~/components/media/author-image.png";
        ...
        <div className="px-5 pt-[40px] pb-[40px] md:pb-[60px] lg:pb-[100px] bg-white relative z-[2]">
            <div className="hidden md:flex absolute z-[1] top-[481px] md:top-[581px] right-[0px] md:right-[0]">
                <svg xmlns="http://www.w3.org/2000/svg" width="473" height="736" viewBox="0 0 473 736" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_3141_47262" x="0" y="0" width="762" height="736" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
            ...
            <div className="flex md:hidden absolute z-[1] top-[100px]  right-[0px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="393" height="736" viewBox="0 0 393 736" fill="none">
                    ...
                    <defs>
                        <filter id="filter0_f_3141_48172" x="-80" y="0" width="762" height="736" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                        <feFlood flood-opacity="0" result="BackgroundImageFix"/>
                        <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
                         ...
                         <div className="flex flex-col md:flex-row gap-11">
                            <div className="w-full md:w-[31.25%]">
                                <div className='bg-DarkOrange rounded-[12px] max-w-[324px]'> 
                                    <img src={AuthorImage} alt="Author" className="w-full h-full rounded-[12px] object-cover"/>
                                </div>
                            </div>
                             <div className="w-full md:w-[68.75%]">
                                <h1 className="mb-3 font-Roboto text-PrimaryBlack font-normal leading-[38.4px] md:leading-[48.4px] text-[32px] md:text-[44px] tracking-[-0.48px] md:tracking-[-0.88px]">Sabrina Jeongco</h1>
                                <p className="mb-6 md:mb-10 font-Roboto text-PrimaryBlack font-normal md:font-medium leading-[24px] md:leading-[28px] text-[16px] md:text-[20px] tracking-[0px] opacity-70">Author</p>
                                <div className='flex flex-col gap-6 mb-5'>
                                    <p className="font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]"> I’m Sab and I enjoy writing about a diverse range of topics. My passion for discovering new areas of interest has brought me to write about virtual mailboxes and remote work.</p>
                                    <p className="font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">I have 5+ years of professional writing experience, covering everything from arts & culture to real estate for various local and international digital, social, and print publications.</p>
                                    <p className="font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">I like dogs, basketball, traveling, and watching movies.</p>
                                </div>
                                <div className='mb-6 md:mb-10'>
                                    <h2 className='mb-3 font-Roboto text-PrimaryBlack font-medium leading-[27px] md:leading-[28px] text-[18px] md:text-[20px] tracking-[0px]'>Writing style</h2>
                                    <p className="mb-5 font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">My writing style adapts to any tone, but I always aim to be as informative and clear as possible.</p>

                                    <h2 className='mb-3 font-Roboto text-PrimaryBlack font-medium leading-[27px] md:leading-[28px] text-[18px] md:text-[20px] tracking-[0px]'>Inspiration and motivation</h2>
                                    <p className="mb-5 font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">I’m motivated to write by a desire to explore the world, learn new things, and share those discoveries with others.</p>

                                    <h2 className='mb-3 font-Roboto text-PrimaryBlack font-medium leading-[27px] md:leading-[28px] text-[18px] md:text-[20px] tracking-[0px]'>Experiences and insights</h2>
                                    <p className="mb-5 font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">Writing about virtual mailboxes has sparked my interest in the digital nomad lifestyle, which has always fascinated me due to my love for traveling. While I’m unsure about adopting it now, exploring virtual mailboxes has shown me how it could be a viable option in the future.</p>

                                    <h2 className='mb-3 font-Roboto text-PrimaryBlack font-medium leading-[27px] md:leading-[28px] text-[18px] md:text-[20px] tracking-[0px]'>Values and beliefs</h2>
                                    <p className="mb-5 font-Roboto text-PrimaryBlack font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">I aim to offer clear, well-researched, and valuable content that addresses the needs of people, particularly in the digital age where information clarity is essential.</p>
        ...
        <div className="px-5 py-[40px] md:py-[60px] lg:py-[100px] bg-[#F6F6F6]">
            <div className="max-w-[1240px] mx-auto">   
                ...
                <div className="">
                    ...
                    <h2 className="font-Roboto text-PrimaryBlack font-semibold leading-[31.2px] md:leading-[61.6px] text-[24px] md:text-[56px] tracking-[-0.36px] md:tracking-[-1.12px]">Blogs by Sabrina Jeongco</h2>
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-3 gap-11 md:gap-x-6 md:gap-y-11">
                        ...
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/cf4b0089bde90959a583d927b62f031739542b4b-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">How to Streamline Mail and Returns for Your eCommerce</h3>
                        ...
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                         ...
                         Running an eCommerce business involves more than just selling products online. From packing 
                        </p>
                        </div>
                        ...
                        <Link to={`#`}>
                        <li className="group relative border border-LightWhite hover:border-PrimaryBlack rounded-[20px] overflow-hidden bg-white transition">
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/e02bf6c26e001c21cb6ef53771a99b8af3ca48eb-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">Why Every eCommerce Seller Needs a Virtual Business Address</h3>
                        
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                        
                         You started your online store with just a laptop and a dream: packing orders at home, handling customer questions between 
                        </p>
                        </div>
                        ...
                        <Link to={`#`}>
                        <li className="group relative border border-LightWhite hover:border-PrimaryBlack rounded-[20px] overflow-hidden bg-white transition">
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/451e23a76560203dd209cbe2113c5fb4dfdc0497-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">Behind-the-Scenes: How Top Content Creators Stay Organized While Traveling</h3>
                        
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                        
                        Travel and content creation go hand in hand, but things are bound to get tricky when you’re trying to stay …
                        </p>
                        </div>
                        ...
                        <Link to={`#`}>
                        <li className="group relative border border-LightWhite hover:border-PrimaryBlack rounded-[20px] overflow-hidden bg-white transition">
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/808c23b950894d4939a351fa124aa0e5725f696d-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">How to Manage Fan Mail and Brand Deals Like a Pro</h3>
                        
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                        
                         Imagine this: your videos start going viral, your follower count climbs fast, and suddenly, your inbox is exploding. There’s a  
                        </p>
                        </div>
                        ...
                        <Link to={`#`}>
                        <li className="group relative border border-LightWhite hover:border-PrimaryBlack rounded-[20px] overflow-hidden bg-white transition">
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/21feaa5f72bcb6d06f9ec1d105cd875f72556207-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">Turning Your Virtual Business Address into a Competitive Advantage</h3>
                        
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                        
                        What if your business address could do more than just collect mail? In today’s digital economy, where trust and credibility
                        </p>
                        </div>
                        ...
                        <Link to={`#`}>
                        <li className="group relative border border-LightWhite hover:border-PrimaryBlack rounded-[20px] overflow-hidden bg-white transition">
                        <img src="https://cdn.sanity.io/images/m5xb8z9y/production/1ba162b8ead9c3e06cb45e1fb9dd741eec083742-1600x900.webp" alt="The Hidden Costs of Poor Mail Management for E-Commerce Businesses" className="w-full rounded-t-[20px] h-[249px] object-cover"/>
                        ...
                        <div className="p-6">
                            ...
                            <h3 className="mt-4 line-clamp-2 font-Roboto text-PrimaryBlack font-semibold leading-[28px] md:leading-[31.2px] text-[20px] md:text-[24px] tracking-[-0.3px] md:tracking-[-0.36px]">How a Virtual Mailbox Helps Digital Nomad E-Commerce Entrepreneurs Stay Connected</h3>
                        
                        <p className="line-clamp-2 mt-2 font-Roboto text-LightGray font-normal leading-[21px] md:leading-[24px] text-[14px] md:text-[16px] tracking-[0px]">
                        
                        Imagine you’re a digital nomad running a thriving e-commerce business. One month you’re sourcing inspiration in Portugal, the next you’re 
                        </p>
                        </div>
