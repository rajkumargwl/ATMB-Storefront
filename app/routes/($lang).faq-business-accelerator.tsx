...
import { FAQ_BUSINESS_ACCELERATOR_PAGE } from '~/queries/sanity/fragments/pages/faqbusinessaccelerator';
...
export async function loader({ context, params }: LoaderFunctionArgs) {
  ...
  const page = await context.sanity.query({
    query: FAQ_BUSINESS_ACCELERATOR_PAGE,
    params: { language  }
  });
...
export default function FAQ() {
  ...
  return (
    <SanityPreview data={page} query={FAQ_BUSINESS_ACCELERATOR_PAGE}>
      {(page) => (
        <Suspense>
          <Await resolve={gids}>
