...
import { MARKETPLACE_PAGE } from '~/queries/sanity/fragments/pages/marketplacepage';

// -----------------
// SEO
// -----------------
const seo: SeoHandleFunction = ({ data }) => ({
  title: data?.page?.seo?.title || 'Marketplace - Anytime Mailbox',
  description:
...
export default function Marketplace() {
  ...
  return (
    <SanityPreview data={page} query={MARKETPLACE_PAGE}>
      {(page) => (
        <Suspense>
          <Await resolve={gids}>
