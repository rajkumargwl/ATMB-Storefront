    ...
    <div className="">
      <div className="px-5  pt-[40px] md:pt-[40px]  pb-10 md:pb-[60px] lg:pb-[100px]">
        <div className="max-w-[1240px] mx-auto">
          <div className="flex items-center flex-row gap-[7px] mb-6">
           <Link to={`/blogs`}><span className="font-Roboto text-LightGray font-normal leading-[14px] md:leading-[14px] text-[14px] md:text-[14px] tracking-[0.07px]">Blog</span> </Link>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
             ...
             <span className="font-Roboto text-PrimaryBlack font-normal leading-[14px] md:leading-[14px] text-[14px] md:text-[14px] tracking-[0.07px]">Blog detail</span>
          </div>
        </div>
        <div className="max-w-[1240px] mx-auto">
          {/* Main Post */}     
          ...
          <div className="flex flex-col lg:flex-row gap-11">
            ...
            <div className="w-full lg:w-[32.8%] xl:min-w-[436px] xl:mr-[-44px]">
              {featured && (
                <aside className="flex flex-col gap-6 md:gap-8 border border-[#F6F6F6] rounded-[20px] p-5 md:p-6 bg-[#F6F6F6] h-fit">
                  ...
                  {featured.mainImage && <img src={featured.mainImage} alt={featured.title} className="w-[90px] md:w-[123px] h-[76px] md:h-[103px] rounded-[12px]" />}
                  ...
                  <div className="flex flex-col gap-6 p-6 border border-LightWhite rounded-[24px] bg-PrimaryBlack ">
                   ...
                   <Link to={`/create-account`}><button className="flex items-center justify-center w-full bg-DarkOrange text-white font-medium font-Roboto leading-[16px] text-[16px] tracking-[0.08px] py-[18px] md:py-[18px] rounded-full">Get Started Today</button></Link>
                  </div>
                </aside>            
              )}
            </div>
