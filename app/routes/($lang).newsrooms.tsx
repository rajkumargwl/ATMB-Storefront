...
export async function loader({ context }: LoaderFunctionArgs) {
  ...
  // Map news items to structured format
...
// Group news by year to check counts
...
console.log("News counts per year:", yearCounts);
// Example: { '2024': 5, '2023': 8, '2022': 3 }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            {Object.entries(groupedByYear)
              .sort((a, b) => parseInt(b[0]) - parseInt(a[0])) // Sort years desc
              .map(([year, cards]) => (
                <section key={year}>
                            ...
                            <div className="flex-shrink-0">
                              <Image
                                data={{
                                  ...
                                  width:
                                    card.logo.asset.metadata?.dimensions?.width,
                                  height:
                                    card.logo.asset.metadata?.dimensions?.height,
                                }}
