            ...
            <div key={study?._id} className="flex flex-col">
              ...
              {study?.slug ? (
                <Link
                  ...
                  className="mt-5 md:mt-6 w-[193px] h-[44px] md:h-[52px] flex items-center justify-center px-4 py-3 rounded-full border border-PrimaryBlack font-Roboto text-PrimaryBlack font-normal text-[16px] md:text-[16px] leading-[16px] tracking-[0.08px] transition-all  hover:bg-PrimaryBlack hover:text-white"
                >
                  View Case Study
                </Link>
              ) : (
                <p className="mt-4 font-Roboto text-PrimaryBlack font-normal text-[16px] md:text-[16px] leading-[16px] tracking-[0.08px]">No link available</p>
              )}
            </div>
          ))}
        </div>
