...
export const productType = defineType({
  ...
  fields: [
   ...
   defineField({
      ...
      type: 'array',
      group: 'editorial',
      description: 'Add Product Detail Page modules such as features, highlights, and location.',
      of: [
        {type: 'pdpdetailedFeaturesSection'},
        {type: 'pdpmailCenterHighlightsSection'},
        {type: 'pdpvirtualMailboxLocation'},
         {type: 'testimonial'},
         {type: 'whyJoinSection'},
          {type: 'buisnesshowitwork'},
          {type: 'pdpFeatureGridSection'},
