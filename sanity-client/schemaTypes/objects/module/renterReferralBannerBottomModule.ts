...
export const renterReferralBannerBottomModule =  defineType({
  name: 'renterReferralBannerBottomModule',
  title: 'Renter Referral Banner Bottom Module',
  type: 'object',
  ...
  preview: {
    ...
    prepare({ title, media, subtitle }) {
      return {
        title: title || 'Referral Banner Bottom Section',
